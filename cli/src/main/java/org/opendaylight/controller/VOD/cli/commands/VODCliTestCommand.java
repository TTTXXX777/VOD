 ...
 */
package org.opendaylight.controller.VOD.cli.commands;
...
public class VODCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(VODCliTestCommand.class);
    protected final VODCliCommands service;

    public VODCliTestCommand(final VODCliCommands service) {
